...
| 站点主题       | 跟随站点 `/theme_switch` 配色；首次未打开过主题页会跳转引导；补齐站点未声明的 `--card-bg` / `--bg-soft`                                                                                              |
| Ctrl/Cmd+Enter | 在输入框中提交：点击离当前输入最近的 submit（优先同 form 内）                                                                                                                                          |
| 自动签到       | 主页侧栏「每日签到」未完成时自动点一次签到按钮                                                                                                                                                         |
